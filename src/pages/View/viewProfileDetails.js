...
import {Email, Phone, Pin, Verify, VerifySuccess} from "../../common/Icons";
    ...
    return (
        <div className="bg-[#F3F2F1] min-h-screen">
            <div className="max-w-7xl mx-auto p-6 flex flex-col sm:flex-col md:flex-row gap-6">
                                        ...
                                        <div>
                                            {skill?.subSkill?.map((sub, i) => (
                                                <div className="border flex justify-between my-2 items-center">
                                                    ...
                                                    {(sub?.certificate && sub?.link) &&
                                                        <div className='mr-3'><VerifySuccess/></div>}
                                                    {isOpen && (
                ...
                {/* Video Section */}
                <div
                    className="order-2 lg:order-2 flex-[1] lg:sticky lg:top-6 rounded-2xl text-center flex flex-col items-center space-y-4 h-fit w-full">
