        ...
        <div className="w-full h-screen flex items-center justify-center bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 md:bg-none">
            <div
                ...
                <div className="w-full h-full flex flex-col md:flex-row items-center justify-center">
                    ...
                    {/* Register */}
                    <div
                        className={`w-full text-center md:w-1/2 h-full flex flex-col justify-center items-center p-10 bg-white transition-all duration-700 ${
                            isRegistering ? 'z-10 opacity-100' : 'z-0 opacity-0 pointer-events-none hidden md:block'
                        }`}
                    >
                    ...
                    {/* Login */}
                    <div
                        className={`w-full md:w-1/2 h-full flex flex-col justify-center items-center p-10 bg-white transition-all duration-700 ${
                            isRegistering ? 'z-0 opacity-0 pointer-events-none' : 'z-10 opacity-100'
                        }`}
                    >
