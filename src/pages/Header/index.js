...
const Header = () => {
    ...
    const MobileNav = () => (
        <div
            ...
            <div
                className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg p-5 transition-transform duration-300 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div>
                ...
                <nav className="flex flex-col gap-4">
                    ...
                    <span onClick={() => {
                        navigate('/messaging');
                        toggleMobileMenu();
                    }} className="cursor-pointer">Messaging</span>
                    {shareButtons}
                    {profileButton}
                </nav>
            </div>
    ...
    const shareButtons = (slug && (
        <div className="relative inline-block text-left group">
            <div>
                <button
                    ...
                    aria-expanded="false"
                    type="button"
                    className="relative cursor-pointer flex items-center peer"
                >
          ...
          <span className="flex items-center gap-2 border-r border-white pr-2">
            ...
            <div
                className="invisible opacity-0  group-focus-within:visible group-focus-within:opacity-100
                 absolute right-0 top-10 mt-2 py-2 w-44 bg-white rounded-md z-10 border border-gray-200 shadow-lg transition-opacity duration-200"
                role="menu"
                aria-orientation="vertical"
                aria-labelledby="menu-button"
                tabIndex="-1"
            >
                <div className="flex flex-col gap-2 items-start" role="none">
                    <button
                        onClick={handleCopy}
                        className="flex items-center gap-2 text-sm px-4 w-full  py-2 hover:bg-gray-100"
                        role="menuitem"
                        tabIndex="-1"
                    ...
                    <a
                        ...
                        className="flex items-center gap-2 px-4 w-full text-sm py-2 hover:bg-gray-100"
                        role="menuitem"
                        tabIndex="-1"
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="w-4 h-4">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v.217l-8 4.8-8-4.8V4zm0 1.383v6.634l5.803-3.482L0 5.383zM6.761 9.674l-6.38 3.827A2 2 0 0 0 2 14h12a2 2 0 0 0 1.619-.499l-6.38-3.827-.736.443a1 1 0 0 1-1.007 0l-.736-.443zm3.436-1.139L16 12.017V5.383l-5.803 3.152z"/>
                        </svg>
                        Email
                    </a>
                </div>
        ...
        const profileButton = (
            <div className="relative flex items-center group">
                ...
                <div
                    className={`invisible opacity-0  group-focus-within:visible group-focus-within:opacity-100 absolute right-0 top-10 mt-2 w-36 bg-white rounded-md z-10 border border-gray-200 transition-opacity duration-200`}
                    role="menu"
                    aria-orientation="vertical"
                    aria-labelledby="menu-button"
                    tabIndex="-1"
                >
                    <div className="py-1" role="none">
                        <div
                            ...
                            className="flex items-center cursor-pointer gap-2 w-full px-3 text-sm text-gray-700 hover:bg-gray-100 transition duration-200"
                        >
                            <div className="w-10">
                                <UserIcon />
                            </div>
                        ...
                        <div
                            ...
                            className="flex items-center gap-2 cursor-pointer w-full px-3 text-sm text-red-600 hover:bg-red-50 transition duration-200"
                        >
                            <div className="w-10">
                                <LogoutIcon />
                            </div>
