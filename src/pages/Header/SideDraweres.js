...
import { API_ROUTES } from "../../utils/APIs"; // your route config

export default function SideDrawere() {
    ...
    const handleUserClick = async (userId) => {
        try {
            // 1. POST request to start or get chat
            ...
            // 3. Immediately call ALL_CHAT API
            const chatResponse = await axios.get(API_ROUTES.ALL_CHAT, {
                headers: { Authorization: token },
            });

            console.log("All Chats:", chatResponse.data);
            // You can pass this to global store if needed
        } catch (error) {
