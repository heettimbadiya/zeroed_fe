                                        ...
                                        {filteredSkill.sub_skills
                                          ...
                                          .map((sub) => (
                                            <div key={sub.sub_skill}>
                                              <div className="mb-2">
                                                <Label label={`Upload Certificate for ${sub.sub_skill}`} />
                                              </div>
                                              <input
                                                type="file"
                                              ...
                                              {subSkill.certificate && (
                                                <div>
                                                  <p>Uploaded Certificate: {subSkill.certificate}</p>
          ...
          <Form>
            ...
            <FormInfo title="Work Experience" icon={<WorkExperience />}>
              {workExperiences.map((experience, index) => (
                <div key={index}>
                  <div className="flex flex-wrap justify-between items-center gap-x-3 bg-primary-100 p-3 w-full">
